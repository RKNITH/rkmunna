...
// export const register = catchAsyncErrors(async (req, res, next) => {
//   const { avatar, resume } = req.files || {}; // Retrieve files if provided

//   let avatarData = {};
//   let resumeData = {};

//   // POSTING AVATAR if provided
//   if (avatar) {
//     const cloudinaryResponseForAvatar = await cloudinary.uploader.upload(
//       avatar.tempFilePath,
//       { folder: "PORTFOLIO AVATAR" }
...
//     facebookURL,
//     linkedInURL,
//     avatar: avatarData, // Assign avatar data if available
//     resume: resumeData, // Assign resume data if available
//   });
...
export const getUserForPortfolio = catchAsyncErrors(async (req, res, next) => {
  const id = "673d8f471ccf7bbedf8a54ff";
